					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                             <span>Ajouter piece</span>
                            </div>
                            <div class="card-body">
                            <form class="form-valide" action="{{route('storepiece')}}" method="post" enctype="multipart/form-data">
                            @csrf
                                        <div class="row">
                                        ...
                                        <div class="col-xl-6 ">     
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="nom" name="nom" placeholder="donner le nom de piece">
                                                    </div>
                                                </div>
