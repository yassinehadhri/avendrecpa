            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12">
                 ...
                 <?php 
                        ...
                        $voitures=$marques->voiture()->where('type','neuf')->get();
                        ?> 
                        @foreach($voitures as $voiture)
                        <div class="col-lg-3 col-md-4 col-12 ">
                            <div class="single_product">
                                <div class="product_name grid_name">
                                    <h3><a href="{{route('voituredetails',['id'=>$voiture->id])}}" style="font-size: 19px;">{{$voiture->nom}}</a></h3>
                                   
                                </div>
                                <div class="product_thumb">
                                    <a class="primary_img" href="{{route('voituredetails',['id'=>$voiture->id])}}"><img src="{{ asset('uploads/students/'.$voiture->image1) }}" alt="" style="height: 180px;width: 100%;"></a>
                                    ...
                                    <div class="right_caption">
                                        ...
                                        <div class="cart_links_btn">
                                            <a href="{{route('voituredetails',['id'=>$voiture->id])}}" title="add to cart">add to cart</a>
                                        </div>
