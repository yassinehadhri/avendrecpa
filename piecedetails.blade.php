                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-tab">
                        ...
                        <div id="img-1" class="zoomWrapper single-zoom">
                            <a href="#">
                                <img id="zoom1" src="{{ asset('uploads/students/'.$pieces->image) }}" data-zoom-image="assets/img/product/product15.jpg" alt="big-1">
                            </a>
                        </div>
                    ...
                    <div class="product_d_right">
                        <form action="#">
                            ...
                            <div class="price_box">
                                ...
                                <span class=""><i class="far fa-money-bill-alt" style="font-size:19px;color:#ffc107"></i> <SPAN style="font-size:19px">LE PRIX :</SPAN> {{$pieces->prix}} DT</span></span>
