                        ...
                        <div class="col-lg-4 col-md-4 col-12 ">
                            <div class="single_product">
                                <div class="product_name grid_name">
                                    <h3><a href="{{route('accesoiresdetails',['id'=>$accesoire->id])}}"></a> {{$accesoire->nom}}</h3>
                                    <p class="manufacture_product"><a href="#">Accessories</a></p>
                                </div>
                                <div class="product_thumb">
                                    <a class="primary_img" href="{{route('accesoiresdetails',['id'=>$accesoire->id])}}"><img src="{{ asset('uploads/students/'.$accesoire->image) }}" alt="" style="    height: 300px;
"></a>
                                ...
                                <div class="product_content grid_content">
                                    <div class="content_inner">
                                        ...
                                        <div class="product_footer d-flex align-items-center">
                                            <div class="price_box">
                                                <span class="current_price">PRIX :</span>
                                                <span class="">{{$accesoire->prix}} DT</span>
                                            </div>
                                            <div class="add_to_cart">
                                                <a href="{{route('accesoiresdetails',['id'=>$accesoire->id])}}" title="add to cart"><span class="lnr lnr-cart"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="product_content list_content">
                                    <div class="left_caption">
                                        <div class="product_name">
                                            <h3><a href="product-details.html" style="font-size:30px"></a></h3>
                                        </div>
