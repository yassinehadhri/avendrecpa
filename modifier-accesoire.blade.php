                ...
                <div class="row">
					...
					<div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                            <form class="form-valide" action="{{route('modifieraccesoire.store',['id'=>$accesoire->id])}}" method="post"  enctype="multipart/form-data">
                            @csrf
                                        <div class="row">
                                        ...
                                        <div class="col-xl-6 ">     
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="nom" name="nom" placeholder="donner le nom"  value="{{$accesoire->nom}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="prix" name="prix" placeholder="donner le Prix" value="{{$accesoire->prix}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="reference" name="reference" placeholder="donner le reference" value="{{$accesoire->references}}">
                                                    </div>
                                                </div>
