                ...
                <div class="row">
					...
					<div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                            <form class="form-valide" action="{{route('storevoiture')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                        <div class="row">
                                        ...
                                        <div class="col-xl-6 ">     
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="nom" name="nom" placeholder="donner le nom de modèle">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="date" class="form-control" id="date" name="date" placeholder="donner le Date">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="number" class="form-control" id="Kms" name="kms" placeholder="donner le kilométrage" >
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="Localité" name="localite" placeholder="donner le localisation">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="Couleur" name="couleur" placeholder="donner le Couleur">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
