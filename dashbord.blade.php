...
<!-- Mirrored from mediqu.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Jun 2021 16:31:41 GMT -->
<head>
    <meta charset="utf-8">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="images/carlogo.jpg" alt="" style="width:100px">
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
				...
				<div class="copyright">
					<p><strong>Mediqu Hospital Admin Dashboard</strong> © 2021 All Rights Reserved</p>
												...
												<tr>
													<td>
														<div class="media align-items-center">
															...
															<div class="media-body">
																<a href="patient-details.html"><h5 class="mt-0 mb-1">Angela Nurhayati</h5></a>
												...
												<tr class="active">
													<td>
														<div class="media align-items-center">
															...
															<div class="media-body">
																<a href="patient-details.html"><h5 class="mt-0 mb-1">James Robinson</h5></a>
												...
												<tr>
													<td>
														<div class="media align-items-center">
															...
															<div class="media-body">
																<a href="patient-details.html"><h5 class="mt-0 mb-1">Thomas Jaja</h5></a>
												...
												<tr>
													<td>
														<div class="media align-items-center">
															...
															<div class="media-body">
																<a href="patient-details.html"><h5 class="mt-0 mb-1">Cindy Brownleee</h5></a>
												...
												<tr>
													<td>
														<div class="media align-items-center">
															...
															<div class="media-body">
																<a href="patient-details.html"><h5 class="mt-0 mb-1">Oconner Jr.</h5></a>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="widget-media best-doctor">
											<ul class="timeline dz-scroll height630" id="bestDoctorsContent">
												<li>
													<div class="timeline-panel">
														...
														<div class="media-body">
															<a href="doctors-details.html"><h4 class="mb-2">Dr. Samantha Queque</h4></a>
												...
												<li>
													<div class="timeline-panel active">
														...
														<div class="media-body">
															<a href="doctors-details.html"><h4 class="mb-2">Dr. Abdul Aziz Lazis</h4></a>
												...
												<li>
													<div class="timeline-panel">
														...
														<div class="media-body">
															<a href="doctors-details.html"><h4 class="mb-2">Dr. Samuel Jr.</h4></a>
												...
												<li>
													<div class="timeline-panel">
														...
														<div class="media-body">
															<a href="doctors-details.html"><h4 class="mb-2">Dr. Alex Siauw</h4></a>
															<p class="mb-2 text-primary">Physical Therapy</p>
															<div class="star-review">
																<i class="fa fa-star text-orange"></i>
																<i class="fa fa-star text-orange"></i>
												...
												<li>
													<div class="timeline-panel">
														...
														<div class="media-body">
															<a href="doctors-details.html"><h4 class="mb-2">Dr. Jennifer Ruby</h4></a>
									...
									<div class="card-footer text-center border-0 pt-0">
										<a class="text-primary dz-load-more" id="bestDoctors" href="javascript:void(0)" rel="ajax/best-doctors.html">See More >></a>
									</div>
								</div>
							</div>
						</div>
...
<!-- Mirrored from mediqu.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Jun 2021 16:32:26 GMT -->
</html>